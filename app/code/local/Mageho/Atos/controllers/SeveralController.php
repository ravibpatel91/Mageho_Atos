...
class Mageho_Atos_SeveralController extends Mageho_Atos_Controller_Action
{
    ...
    public function redirectAction()
    {
		...
		Mage::dispatchEvent('atos_controller_several_redirect_render_before', array(
    ...
    public function failureAction() 
    {
        ...
        $this->getAtosSession()->setAtosSeveralPaymentMeans($paymentMeans);
