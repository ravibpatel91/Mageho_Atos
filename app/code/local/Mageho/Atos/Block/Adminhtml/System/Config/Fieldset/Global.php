...
class Mageho_Atos_Block_Adminhtml_System_Config_Fieldset_Global
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
     ...
     * @var string
     */
    protected $_template = 'mageho/atos/system/config/fieldset/global.phtml';
    ...
    {
        return Mage::helper('atos')->getElementBackendConfig($element);
    }
}
